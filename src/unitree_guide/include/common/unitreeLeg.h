...
public:
    ...
    ~QuadrupedLeg(){}
    Vec3 calcPEe2H(Vec3 q); // postion end 2 hip because initial point is put on the hip
    Vec3 calcPEe2B(Vec3 q); // postion end 2 body
    Vec3 calcVEe(Vec3 q, Vec3 qd); 
    Vec3 calcQ(Vec3 pEe, FrameType frame);   // reverse kinematics; calculate q in frame
